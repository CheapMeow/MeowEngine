...
namespace Meow
{
        ...
        : Window(id, glfw_window)
    {
        ...
        //                     transform_ptr->position = glm::vec3((float)col * spacing - (float)column_number / 2.0f *
        //                     spacing,
        //                                                         (float)row * spacing - (float)row_number / 2.0f *
        //                                                         spacing, 0.0f);

        //                     auto model_comp_ptr =
        //                         TryAddComponent(gameobject_ptr, "ModelComponent",
